    ...
    createClass(FishboneChart, [{
            ...
            var topCauses = topArray.map(function (category, index) {
                return React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('div', { className: 'diagonalLine ' + color + 'TopBottom' })
                    )
                );
            });
            ...
            var bottomCauses = bottomArray.map(function (category, index) {
                return React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('div', { className: 'diagonalLine ' + color + 'BottomTop' })
                    ),
                    React__default.createElement(
                        'div',
        ...
        value: function getCauses() {
            ...
            return React__default.createElement(
                ...
                React__default.createElement('div', { className: 'lineEffect ' + color + 'Border' }),
