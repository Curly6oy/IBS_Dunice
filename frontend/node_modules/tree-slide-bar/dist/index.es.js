...
var SlideBar = (function (props) {
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('input', { className: 'slider ' + getColor(props.node.value), type: 'range', min: MIN, max: MAX,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement('i', { className: '' + (this.state.hideChildren ? 'icon ion-md-arrow-dropright' : 'icon ion-md-arrow-dropdown') })
                                ),
                                React.createElement(
                                    'div',
                                    null,
                        ...
                        React.createElement(
                            'div',
                            { className: 'controls' },
                            React.createElement(SlideBar, { node: this.state.node, onChange: this.props.onChange, hideSlideBar: this.props.hideSlideBar }),
                            React.createElement(
                                If,
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement('i', { className: 'icon ion-md-create' })
                                        )
                                    ),
                                    React.createElement(
                                        If,
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement('i', { className: 'icon ion-md-trash' })
                                        )
                                    )
                                )
                            )
