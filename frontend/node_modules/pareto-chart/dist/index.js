...
var ChartComponent = function (_React$Component) {
  ...
  ChartComponent.prototype.memoizeDataProps = function memoizeDataProps() {
    ...
    this.shadowDataProp = _extends$1({}, data, {
      datasets: data.datasets && data.datasets.map(function (set) {
        return _extends$1({}, set);
      })
    });
  ...
  ChartComponent.prototype.updateChart = function updateChart() {
    ...
    this.chartInstance.config.data.datasets = nextDatasets.map(function (next) {
      ...
      if (current && current.type === next.type) {
        ...
        return _extends$1({}, current, otherProps);
      } else {
        return next;
      }
    });
    ...
    this.chartInstance.config.data = _extends$1({}, this.chartInstance.config.data, rest);
...
var Doughnut = function (_React$Component2) {
  ...
  Doughnut.prototype.render = function render() {
    ...
    return React__default.createElement(ChartComponent, _extends$1({}, this.props, {
...
var Line$1 = function (_React$Component4) {
...
var ParetoChart = function (_Component) {
    ...
    function ParetoChart(props) {
        ...
        _this.getChartBorderColor = function (index) {
            var colors = ['rgb(0, 192, 239)', 'rgb(216, 27, 96)', 'rgb(104,115,140)', 'rgb(48, 187, 187)', 'rgb(11, 120, 206)', 'rgb(255, 119, 1)', 'rgb(17, 17, 17)', 'rgb(96, 92, 168)'];
        ...
        _this.getSortedData = memoize(function (data, index) {
            var selectedLegend = _this.getSelectedLegend(data, index);
            return _this.sortData(data[selectedLegend]);
        });
    ...
    createClass(ParetoChart, [{
        ...
        value: function sortData(data) {
            var orderedData = Object.entries(data).sort(function (a, b) {
                return b[1] - a[1];
            }).reduce(function (ordered, entry) {
        ...
        key: 'getSelectedLegend',
        value: function getSelectedLegend(data, index) {
            return Object.keys(data)[index];
        }
    }, {
        key: 'getChartData',
        value: function getChartData(data) {
            var total = this.getMaxYAxisValue(data);
            var labels = Object.keys(data);
            var barDataset = Object.values(data).reduce(function (set$$1, e) {
                set$$1.data.push(e);
                return set$$1;
            }, {
            ...
            var before = 0;
            var lineData = barDataset.data.map(function (d) {
                var sum = 100 * d / total + before;
                before = sum;
            ...
            return { labels: labels, datasets: [barDataset, lineDataset] };
        }
    }, {
        key: 'getMaxYAxisValue',
        value: function getMaxYAxisValue(data) {
            var maxYAxisValue = Object.values(data).reduce(function (sum, e) {
                sum += e;
                return sum;
            }, 0);
        ...
        key: 'getLineLabel',
        value: function getLineLabel() {
            return this.props.lineLabel || 'Cumulative percentage';
        }
    }, {
        key: 'render',
        value: function render() {
            var data = this.getSortedData(this.props.data, this.state.index);
            ...
            var maxYAxisValue = this.getMaxYAxisValue(data);
            var lineLabel = this.getLineLabel();
        ...
        value: function getLegend() {
            ...
            var labelsDivs = labels.map(function (label, index) {
                var labelClass = index === _this2.state.index ? 'label_' : 'labelLineThrough';
                var color = _this2.getColor(index);
                return React__default.createElement(
                    'div',
                    { key: 'labels_' + label + '_' + index, className: 'legendLabel', onClick: function onClick() {
                            return _this2.selectDataset(index);
                        } },
                    React__default.createElement('div', { className: 'labelSquare legend all ' + color + '_dark ' + color + 'Border' }),
                    React__default.createElement(
                        'div',
